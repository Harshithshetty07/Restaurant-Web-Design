...
export default function Home() {
  ...
  return (
    <div className="font-poppins m-0">
      <header className="h-[50px] flex justify-between items-center px-[50px] py-[5px] box-border relative z-10">
        <div>LUNDEV</div>
        <nav>
          <ul className="p-0 m-0 list-none flex gap-[30px]">
            <li>Home</li>
            <li>Contact</li>
            <li>Login</li>
          </ul>
      ...
      <div className="w-screen h-screen overflow-hidden relative bg-[#17232A] 
